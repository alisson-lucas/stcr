    ...
    return (
        <div id="about" className="flex items-center justify-center w-full bg-white">
            <div className="flex flex-col items-center justify-between text-start gap-14 w-full lg:max-w-screen-lg 2xl:max-w-screen-xl py-10 lg:py-20 px-8 lg:px-20">
                ...
                <span className='text-gray-700 text-center'>Somos o Seminário Teológico Congregacional do Recife, uma instituição de ensino superior que oferece cursos de graduação, pós-graduação e extensão na área de teologia. Nossa missão é formar líderes cristãos capacitados para servir a Deus e à sua igreja, com base na fé reformada e na confessionalidade congregacional.</span>
            </div>
        </div>
    )
}
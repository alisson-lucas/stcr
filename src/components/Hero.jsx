export default function Hero() {
    return (
        <div className="flex items-center justify-center relative w-full shadow-lg isolate px-6 py-14 lg:px-8  bg-[url('/images/background.png')] bg-cover bg-center bg-no-repeat after:content[''] after:absolute after:bg-gradient-to-t after:from-black after:to-transparent after:top-0 after:bottom-0 after:right-0 after:left-0 after:z-20">
